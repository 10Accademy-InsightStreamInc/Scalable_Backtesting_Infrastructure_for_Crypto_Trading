...
//               <div className="flex-1 flex flex-col items-start justify-start gap-[16px] min-w-[372px] max-w-full mq450:min-w-full">
//                 <div className="self-stretch flex flex-col items-start justify-start gap-[16px] max-w-full">
//                   <div className="self-stretch rounded-md bg-color-variants-purple-5 p-4 flex flex-col items-start justify-start gap-[8px]">
//                     <h4 className="m-0 relative text-inherit leading-[28px] font-medium font-inherit mq450:text-lg mq450:leading-[24px]">
//                       Number of Trades
//                     </h4>
//                     <div className="relative text-base tracking-[0.2px] leading-[20px] text-white-background-primary">
//                       100
//                     </div>
//                   </div>
//                   <div className="self-stretch rounded-md bg-color-variants-green-5 p-4 flex flex-col items-start justify-start gap-[8px]">
//                     <h4 className="m-0 relative text-inherit leading-[28px] font-medium font-inherit mq450:text-lg mq450:leading-[24px]">
//                       Winning Trades
//                     </h4>
//                     <div className="relative text-base tracking-[0.2px] leading-[20px] text-white-background-primary">
...
//                       </div>
// </div>
// <div className="self-stretch rounded-md bg-color-variants-red-5 p-4 flex flex-col items-start justify-start gap-[8px]">
//   <h4 className="m-0 relative text-inherit leading-[28px] font-medium font-inherit mq450:text-lg mq450:leading-[24px]">
//     Losing Trades
//   </h4>
//   <div className="relative text-base tracking-[0.2px] leading-[20px] text-white-background-primary">
...
//   </div>
// </div>
// <div className="self-stretch rounded-md bg-color-variants-yellow-5 p-4 flex flex-col items-start justify-start gap-[8px]">
//   <h4 className="m-0 relative text-inherit leading-[28px] font-medium font-inherit mq450:text-lg mq450:leading-[24px]">
//     Max Drawdown
//   </h4>
//   <div className="relative text-base tracking-[0.2px] leading-[20px] text-white-background-primary">
...
//   </div>
// </div>
// <div className="self-stretch rounded-md bg-color-variants-blue-5 p-4 flex flex-col items-start justify-start gap-[8px]">
//   <h4 className="m-0 relative text-inherit leading-[28px] font-medium font-inherit mq450:text-lg mq450:leading-[24px]">
//     Sharpe Ratio
//   </h4>
//   <div className="relative text-base tracking-[0.2px] leading-[20px] text-white-background-primary">
    ...
    >
      ...
      <div className="self-stretch flex flex-col items-start justify-start gap-[24px] max-w-full">
        <div className="self-stretch flex flex-col items-center justify-center gap-[16px] max-w-full">
          <h1 className="m-0 text-center font-bold text-inherit leading-[32px] font-medium font-inherit mq450:text-lgi mq450:leading-[26px]">
            Backtest Results
          </h1>
          <div className="self-stretch flex flex-row flex-wrap items-start justify-start gap-[48px] max-w-full mq675:gap-[24px]">
            <div className="flex-1 flex flex-col items-start justify-start gap-[16px] min-w-[372px] max-w-full mq450:min-w-full">
              <div className="flex flex-col items-start justify-start gap-[8px]">
                ...
                <div className="self-stretch rounded bg-light-theme-background-bg box-border flex flex-row items-center justify-start py-2.5 pr-4 pl-4 max-w-full text-base text-lightgray border-[1px] border-solid border-light-theme-border-and-divider-border-and-divider">
                  <div className="relative text-base tracking-[0.2px] leading-[20px] text-[inherit] inline-block">
                    100
                  </div>
                </div>
              </div>
